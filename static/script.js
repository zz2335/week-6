...
function updateData(){
	...
	var checked1 = document.getElementById("heatmap").checked
	...
	request = "/getData?lat1=" + lat1 + "&lat2=" + lat2 + "&lng1=" + lng1 + "&lng2=" + lng2 + "&w=" + w + "&h=" + h + "&cell_size=" + cell_size + "&analysis=" + checked + "&heatmap=" + checked1 + "&spread=" + spreadvalue
